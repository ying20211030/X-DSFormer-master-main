...
# X-DSFormer：Dual-domain synergy of frequency modulation and Wavelet sub-band guidance in an efficient Transformer for X-ray image denoising.
X-DSFormer, which integrates frequency modulation and wavelet sub-band guided dual-domain collaboration into an efficient Transformer framework to enhance X-ray image denoising performance. 
...
- 📊 Evaluation scripts and sample datasets
- 📖 Detailed documentation

## License
The license will be released along with the code.
